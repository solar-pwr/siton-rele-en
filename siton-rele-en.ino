...
#define VCC 5000 // napajeci napeti v mV pro vypocty
...
byte stupen2[8] = {0b01100, 0b11110, 0b11110, 0b01100, 0b00000, 0b00000, 0b00000, 0b00000};
int klavesa;
...
void setup() {
  ...
  pinMode(enable_pin, OUTPUT); //ovladani rele
  ...
  lcd.createChar(2, stupen2); // ulozi do LCD symbol stupnu
...
void mereni()
{
  ...
  //vykon = 3500;//###DEBUG###
  if (totT > 1020) // pokud je odpojené termočidlo nastav 0 oC
  {
    totT = 437;
  }
